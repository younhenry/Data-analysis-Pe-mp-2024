...
plating_data=read.table(here::here("Pe_survival_and_load/Pe_survival_and_load/data_plating.txt"),h=T, dec=".")
head(plating_data)

offspring_data=read.table(here::here("Pe_survival_and_load/Pe_survival_and_load/data_offspring.txt"),h=T, dec=".")
head(offspring_data)
...
pdf(height=5, width=5, file=here::here("Pe_survival_and_load/Plot_survival_obsvsfitted_finaltime.pdf"))
Plot_survival_obsvsfitted +
...
if(file.exists(here::here("Pe_survival_and_load/survival_differences_to_control.docx")))
{
}else{
    save_as_docx(table_by_OD, path = here::here("Pe_survival_and_load/survival_differences_to_control.docx"))
  }
...
pdf(height=5, width=5, file=here::here("Pe_survival_and_load/Plot_CFU_obsvsfitted_finaltime.pdf"))
Plot_CFU_obsvsfitted +
  theme(strip.text.x = element_markdown(size = 8), strip.text.y = element_blank(), strip.background.y = element_blank(), legend.title = element_blank(), plot.margin = margin(t = 30, r = 22, b = 6, l = 6, unit = "pt"), panel.border = element_rect(colour = "grey20", fill=NA, size=0.4))
dev.off()
...
if(file.exists(here::here("Pe_survival_and_load/CFU_differences_to_control.docx")))
{
}else{
    save_as_docx(table_CFU_by_OD, path = here::here("Pe_survival_and_load/CFU_differences_to_control.docx"))
  }
...
if(file.exists(here::here("Pe_survival_and_load/CFU_differences_to_nochange.docx")))
{
}else{
    save_as_docx(table_CFU_by_change, path = here::here("Pe_survival_and_load/CFU_differences_to_nochange.docx"))
  }
...
pdf(height=5, width=10, file=here::here("Pe_survival_and_load/plot_summary.pdf"))
...
pdf(height=6, width=5, file=here::here("Pe_survival_and_load/plot_summary_nochange.pdf"))
grid::grid.newpage()
...
pdf(height=4, width=3, file=here::here("Pe_survival_and_load/Plot_offspring.pdf"))
plot_offspring+
  theme(panel.grid.major.x = element_blank(), panel.grid.major.y = element_line(color = "grey95", size = 0.4), panel.grid.minor = element_blank())+
