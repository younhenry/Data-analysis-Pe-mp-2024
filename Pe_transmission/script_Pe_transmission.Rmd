...
corCFU=cor.test(x=(1-(data_CFU2$alive_flies/data_CFU2$total_flies)), y=(data_CFU2$CFU_per_fly+1), method="kendall")
...
plot_regression=ggplot(aes(x=(1-(alive_flies/total_flies)), y=(CFU_per_fly+1), colour=infection2), data=data_CFU2)+
  ...
  annotate("text", x = 0.7, y = 200, label = " Kendall's tau = 0.72 \n p-value = 0.008", vjust = -0.3, size= 2)+
